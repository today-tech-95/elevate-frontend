...
const Achievable = ({data,setDataToAdd,openAddModal,getProfile}) => {
  ...
  return (
    <div className="w-full p-[24px] rounded-[12px] border border-[#B1B8C5] ">
      ...
      {data.length <= 0?
      <p className="text-center p-2 text-gray-500">No data is added yet</p>
      :
      <EducationTimeLine 
