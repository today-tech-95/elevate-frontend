  ...
  return (
    <div style={{ position: "relative", height: "500px" }}>
      ...
      <Sidebar position="left">
        <ConversationList>
        <Conversation name='John' lastSenderName='John' info="Hello my friend">
        ...
        <Conversation name='John' lastSenderName='John' info="How are you ?" active={true} >
         <Avatar src="https://images.pexels.com/photos/2340978/pexels-photo-2340978.jpeg?auto=compress&cs=tinysrgb&w=600"/>
        </Conversation>
        </ConversationList>
        </Sidebar>
        <ChatContainer>
         <ConversationHeader>
         <Avatar src="https://images.pexels.com/photos/2340978/pexels-photo-2340978.jpeg?auto=compress&cs=tinysrgb&w=600"/>
         <ConversationHeader.Content userName="John" info="last active 10 min. ago">
